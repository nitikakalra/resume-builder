...
import { ProfileInfoForm, ContactInfoForm,WorkExperienceForm,EducationDetailsForm,SkillsInfoForm,ProjectDetailForm,CertificationInfoForm,AdditionalInfoForm} from '../components/Forms';
...
const EditResume = () => {
  ...
  //IT WILL HELP IN CHOOSING THE PREVIEW AS WELL AS HELPS IN DOWNLOADING THE RESUME . ALSO SAVES THE RESUMES AS AN IMAGE 
  ...
  // DOWNLOAD FUNCTION
    ...
    try {
      await html2pdf()
        ...
        .from(element)
        .save();  //WE WILL SAVE THE RESUME HERE AND THEN WE WILL DOWNLOAD IT 
